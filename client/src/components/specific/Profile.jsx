  ...
  return (
    <Stack spacing={"2rem"} direction={"column"} alignItems={"center"}>
     <Avatar sx={{
      ...
      <ProfileCard heading={"bio"} text={"jffksd jksfnsjf "}/>
      <ProfileCard heading={"Username"} text={"hsfasfj "}Icon={<UserNameIcon/>}/>
      <ProfileCard heading={"Name"} text={"asfjfanfj "} Icon={<FaceIcon/>}/>
